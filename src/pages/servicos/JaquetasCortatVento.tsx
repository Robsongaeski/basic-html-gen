...
const benefits = [
  ...
  'Proteção contra vento e chuva leve',
  'Personalização total',
  'Tecidos impermeáveis e resistentes',
  'Ideal para equipes e eventos',
  'Qualidade e durabilidade'
];

const specifications = {
  tecidos: ['Tactel', 'Nylon', 'Poliéster Impermeável', 'Dry-Fit'],
  personalizacao: ['Full Print (impressão total)', 'Estampas Localizadas', 'Bordado', 'Sublimação'],
  caracteristicas: ['Impermeável', 'Corta vento', 'Com capuz (opcional)', 'Bolsos laterais', 'Zíper frontal'],
...
const processSteps = [
  ...
  },
  {
    step: 2,
    title: 'Arte',
    description: 'Criamos ou adaptamos sua arte para full print ou estampa localizada.',
    icon: Palette,
    image: designImage
  },
  {
    step: 3,
    title: 'Produção',
    description: 'Confeccionamos com tecidos de alta qualidade e personalização perfeita.',
    icon: Wind,
...
const faq = [
  {
    question: 'Qual o pedido mínimo para jaquetas corta vento?',
  ...
  },
  {
    ...
    answer: 'O prazo padrão é de 15 a 20 dias úteis após aprovação da arte e confirmação do pedido, devido ao processo de personalização.'
  },
  {
    question: 'Qual a diferença entre full print e estampa localizada?',
    answer: 'Full print cobre toda a superfície da jaqueta com a estampa, enquanto estampa localizada é aplicada em áreas específicas como frente, costas ou mangas.'
  },
  {
    question: 'As jaquetas são realmente impermeáveis?',
    answer: 'Sim! Utilizamos tecidos com tratamento impermeável que protegem contra chuva leve e vento, mantendo conforto e proteção.'
  },
  {
    question: 'Vocês fazem a arte para full print?',
    answer: 'Sim! Temos equipe especializada em criar artes para full print ou adaptamos sua arte existente para o melhor resultado.'
  }
];
        ...
        <div className="relative container-responsive">
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-gray-200 mb-6 leading-relaxed max-w-2xl drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
              Jaquetas corta vento totalmente personalizadas em full print ou com estampas localizadas. 
              Proteção, estilo e qualidade para sua equipe ou evento.
            </p>
            ...
            <Button asChild className="cta-whatsapp text-lg px-8 py-4">
              <a 
                href={getWhatsAppLink(WHATSAPP_MESSAGES.SERVICE('Jaquetas Corta Vento'))} 
                target="_blank" 
                rel="noopener noreferrer" 
                className="flex items-center gap-3"
                onClick={() => handleWhatsAppClick('Hero Jaquetas Corta Vento')}
              >
        ...
        <div className="container-responsive">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Exemplos de Jaquetas
            </h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Veja algumas jaquetas corta vento que já produzimos
            </p>
          </div>
      ...
      <section className="section-padding bg-background">
        <div className="container-responsive">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Nosso processo simples e eficiente para suas jaquetas personalizadas
            </p>
          </div>
      ...
      <section className="section-padding bg-gradient-hero text-white">
        <div className="container-responsive text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-950">
            Vamos criar suas jaquetas corta vento?
          </h2>
          ...
          <Button asChild className="cta-whatsapp text-lg px-8 py-4">
            <a 
              ...
              onClick={() => handleWhatsAppClick('CTA Final Jaquetas Corta Vento')}
            >
              <MessageSquare size={20} />
