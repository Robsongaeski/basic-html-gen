...
export default function Servicos() {
  ...
  return (
    <>
      <SEOHead 
        title="Serviços"
        description="Confira todos os serviços da Gatha Confecções: camisetas personalizadas, uniformes esportivos, uniformes empresariais, jaquetas corta vento e moletons."
        url="/servicos"
      />
      ...
      <ServiceSchema 
        ...
        description="Soluções completas em confecção de uniformes e peças personalizadas com produção própria."
        category="Confecção"
      />
      
      <div className="min-h-screen">
        {/* Hero Section */}
        <section className="section-padding bg-gradient-hero text-white" aria-labelledby="services-heading">
          <div className="container-responsive text-center">
            <h1 id="services-heading" className="text-4xl md:text-5xl font-bold mb-6 text-slate-600">
              Nossos Serviços
            </h1>
        ...
        {/* Services Grid */}
        <section className="section-padding bg-background" aria-label="Lista de serviços">
        ...
        <section className="section-padding bg-secondary/30" aria-labelledby="portfolio-heading">
          <div className="container-responsive">
              ...
              {portfolioHighlights.map(item => (
                <Dialog key={item.id}>
                  <DialogTrigger asChild>
                    <article className="card-service cursor-pointer group">
                      <div className="relative mb-4 overflow-hidden rounded-lg">
                        <img 
                          src={item.image} 
                          alt={`${item.title} - Trabalho realizado pela Gatha Confecções`} 
                          loading="lazy"
                          decoding="async"
                          width={400}
                          height={300}
                  ...
                  <DialogContent className="max-w-2xl">
                    <div className="space-y-4">
                      <img 
                        src={item.image} 
                        alt={`${item.title} - Detalhes do trabalho`} 
