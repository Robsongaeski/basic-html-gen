import { MessageSquare, Clock, MapPin, Phone, Instagram, Mail } from 'lucide-react';
      ...
      <section className="section-padding bg-secondary">
        <div className="container-responsive">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-8 text-center">Nossa Localização</h2>
