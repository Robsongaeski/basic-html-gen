...
export default function QuemSomos() {
  return (
    <>
      <SEOHead 
        title="Quem Somos"
        description="Conheça a Gatha Confecções: empresa familiar em Pato Branco - PR com mais de 15 anos de experiência em uniformes e peças personalizadas com produção própria."
        url="/quem-somos"
      />
      <OrganizationSchema />
      ...
      <div className="min-h-screen">
        {/* Hero Section */}
        <section className="relative py-20 lg:py-32 overflow-hidden" aria-labelledby="about-heading">
          <div className="absolute inset-0">
            <img 
              src={heroImage} 
              alt="Gatha Confecções - Nossa fábrica de uniformes em Pato Branco PR" 
              loading="eager" 
              fetchPriority="high" 
              decoding="async" 
              width={1920}
          ...
          <div className="relative container-responsive">
            <div className="max-w-4xl">
              <h1 id="about-heading" className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
                Quem Somos
              </h1>
        ...
        {/* Nossa História */}
        <section className="section-padding bg-background" aria-labelledby="history-heading">
          <div className="container-responsive">
            <div className="max-w-4xl mx-auto">
              <header className="text-center mb-12">
                <h2 id="history-heading" className="text-3xl md:text-4xl font-bold text-foreground mb-6">
                  Nossa História
                </h2>
              </header>
        ...
        {/* Nossos Valores */}
        <section className="section-padding bg-secondary" aria-labelledby="values-heading">
          <div className="container-responsive">
        ...
        {/* Nossa Equipe */}
        <section className="section-padding bg-background" aria-labelledby="structure-heading">
          <div className="container-responsive">
            <header className="text-center mb-16">
              <h2 id="structure-heading" className="text-3xl md:text-4xl font-bold text-foreground mb-4">
                Nossa Estrutura
              </h2>
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {team.map(member => (
                <article key={member.name} className="card-service text-center">
        ...
        {/* Produção Própria */}
        <section className="section-padding bg-gradient-hero text-white" aria-labelledby="production-heading">
          <div className="container-responsive">
            <div className="max-w-4xl mx-auto text-center">
              <h2 id="production-heading" className="text-3xl md:text-4xl font-bold mb-6 text-zinc-950">
                Produção Própria
              </h2>
